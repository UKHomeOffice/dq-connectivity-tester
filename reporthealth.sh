...
DIMENSIONS=Overall=overall,InstanceId=${INSTANCE_ID:-unknown},Name=$(get_tag Name),Service=$(get_tag Service),Environment=$(get_tag Environment),EnvironmentGroup=$(get_tag EnvironmentGroup)
